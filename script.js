...
const VEHICLES = {
  mil:[
    ...
    {name:"Bus militai.",  sub:"Transport de personnel et scolaire",    img:"photos/bus-army.jpg",              badge:"vb-m",bl:"Militaire",desc:"Transport de personne et scolaire.",                         specs:[["Usage","Blindés"],["Type","Fixe/ridelles"],["Arrim.","Sangles"],["Période","1995-2018"]],  tags:["Personne","Scolaire","Armée"]},
  ],
  civ:[
    {name:"Bus urbain articulé 18 m",    sub:"Transport en commun",                  img:"photos/busarticule.jpg",            badge:"vb-c",bl:"Brieselang / Hambourg / Koln",   desc:"Bus articulé de 18m. Deutsche Bahn, Transdev et ÉcoVista.",  specs:[["Longueur","18 m"],["Capacité","~80 pass."],["Moteur","Diesel/GNC"],["Usage","Urbain"]],    tags:["Articulé","Allemagne","France"]},
    {name:"Bus urbain 13 m",             sub:"Haute capacité",                       img:"photos/busurbain.jpg",              badge:"vb-c",bl:"Brieselang / Hambourg",   desc:"Bus urbain 13m. Berlin–Hambourg avec ÉcoVista.",        specs:[["Longueur","13 m"],["Capacité","~150 pass."],["Moteur","Hybride"],["Usage","BRT"]],         tags:["Urbain","Berlin","Hambourg"]},
    {name:"Bus urbain 14 m",             sub:"Station de Ski",                       img:"photos/meribus.jpg",                badge:"vb-c",bl:"Méribel",   desc:"Bus urbain sation de ski. Méribel Savoie avec Transdev.", specs:[["Longueur","14 m"],["Capacité","~150 pass."],["Moteur","Hybride"],["Usage","BRT"]],         tags:["urbain","Méribel","Savoie"]},
    {name:"Car scolaire",                sub:"Transport d'élèves",                   img:"photos/carscolaire.jpg",            badge:"vb-c",bl:"Ain",   desc:"Transport d'élèves pour Transport de l'Ain.",             specs:[["Capacité","55 passagers"],["Permis","D"],["Sécurité","Ceintures"],["Usage","Scolaire"]],   tags:["Scolaire","Permis D","Ain"]},
    {name:"Semi-Remorque",               sub:"Semi-Remorque · Transport de Savoie",  img:"photos/semiremorque.jpg",           badge:"vb-c",bl:"Ain",   desc:"Livraison de marchandise sec au supermarché Carrefour.",  specs:[["Capacité","44 tonnes"],["Permis","CE"],["Sécurité","Conduite"],["Usage","Supply Chain"]],  tags:["Marchandise","Permis CE","Ain"]},
    ...
    {name:"Camion Citerne",              sub:"Semi-Remorque · Biolait",              img:"photos/citerne.jpg",                badge:"vb-us",bl:"Bretagne", desc:"Semi-Remorque Bretagne pour la Collecte de lait.",        specs:[["Permis","CE"],["PTAC","44 t"],["Exp.","2020 pendant le COVID"],["Marque","Kenworth"]],     tags:["Canada","XTL","Classe 1"],us:true},
  ]
};
